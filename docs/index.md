...
# License
mlna has a CC BY-NC 4.0 license. For more detail, see the [LICENSE.md](https://github.com/Goli-SF/MLNA/blob/main/LICENSE.md) file. For the third-party licenses of other packages used for the development of mlna, see the [THIRD_PARTY_LICENSES.md](https://github.com/Goli-SF/MLNA/blob/main/THIRD_PARTY_LICENSES.md) file.
